    ...
    <section className="bg-white border border-black/10 rounded-xl p-5 mb-4">
      ...
      {!readOnly && (
        <button
          type="button"
          onClick={add}
          className="inline-flex items-center gap-1.5 border border-dashed border-black/25 rounded-lg px-3.5 py-2 text-[13px] font-semibold text-[var(--horizon)] mt-3 hover:border-[var(--denim)]"
        >
          + Add a goal
        </button>
      )}
